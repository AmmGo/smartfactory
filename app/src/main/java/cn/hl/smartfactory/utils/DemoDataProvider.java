...
package cn.hl.smartfactory.utils;
...
import cn.hl.smartfactory.adapter.entity.NewInfo;
...
public class DemoDataProvider {
    ...
    public static List<AdapterItem> getGridItems1(Context context) {
        return getGridItems(context, R.array.grid_titles_entry1, R.array.grid_icons_entry1);
    }
