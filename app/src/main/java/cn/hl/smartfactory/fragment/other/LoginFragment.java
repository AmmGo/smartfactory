...
package cn.hl.smartfactory.fragment.other;

import android.graphics.Color;
import android.view.View;
import android.widget.CheckBox;

import cn.hl.smartfactory.activity.MainActivity;
import cn.hl.smartfactory.core.BaseFragment;
import cn.hl.smartfactory.utils.RandomUtils;
import cn.hl.smartfactory.utils.SettingUtils;
import cn.hl.smartfactory.utils.TokenUtils;
import cn.hl.smartfactory.utils.Utils;
import cn.hl.smartfactory.utils.XToastUtils;
import cn.hl.smartfactory.utils.sdkinit.UMengInit;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_user_protocol:
                openPage(ServiceProtocolFragment.class, ServiceProtocolFragment.KEY_PROTOCOL_TITLE, ResUtils.getString(R.string.title_user_protocol));
                break;
            case R.id.tv_privacy_protocol:
                openPage(ServiceProtocolFragment.class, ServiceProtocolFragment.KEY_PROTOCOL_TITLE, ResUtils.getString(R.string.title_privacy_protocol));
                break;
            default:
                break;
        }
